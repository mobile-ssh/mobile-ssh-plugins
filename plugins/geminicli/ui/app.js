/* Gemini CLI plugin — installs the gemini CLI on the remote (user-local, no root). */
(function () {
  'use strict';
  ...
  document.getElementById('setup').onclick = async function () {
    ...
    var nextLabel = 'Install Gemini CLI';
    try {
      ...
      log('Installed. Go back to the terminal (\u2039) and run `gemini` \u2014 best inside tmux.');
