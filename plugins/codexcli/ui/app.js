/* Codex CLI plugin — installs the codex CLI on the remote (user-local, no root). */
(function () {
  'use strict';
  ...
  document.getElementById('setup').onclick = async function () {
    ...
    var nextLabel = 'Install Codex CLI';
    try {
      ...
      log('Installed. Go back to the terminal (\u2039) and run `codex` \u2014 best inside tmux.');
